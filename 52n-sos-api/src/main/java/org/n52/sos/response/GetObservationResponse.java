...
//                 new SosCompositePhenomenon("CompositePhenomenon_" + this.observationConstellation.getProcedure(),
//                         null, obsProps);
...
//         SosCompositePhenomenon sosCompPhen =
//                 (SosCompositePhenomenon) this.observationConstellation.getObservableProperty();
//         sosCompPhen.getPhenomenonComponents().add(
//                 (SosObservableProperty) sosObservation.getObservationConstellation().getObservableProperty());
//     }
//     // add values

...
public class N52XmlHelper {
	 ...
	 *            schema location
	 */
	public static void setSchemaLocationToDocument(XmlObject document,
	 ...
	 *            schema locations
	 */
	public static void setSchemaLocationsToDocument(XmlObject document,
		...
		schemaLocation = schemaLocation.deleteCharAt(schemaLocation
				.lastIndexOf(" "));
	...
	public static String getSchemaLocationForOM100() {
		return OMConstants.NS_OM + " "
				+ OMConstants.SCHEMA_LOCATION_OM_CONSTRAINT;
	}
	...
	public static String getSchemaLocationForGML321() {
		return GMLConstants.NS_GML_32 + " "
				+ GMLConstants.SCHEMA_LOCATION_GML_32;
	}
	...
	public static String getSchemaLocationForSML101() {
		return SensorMLConstants.NS_SML + " "
				+ SensorMLConstants.SCHEMA_LOCATION_SML;
	}
	...
	public static String getSchemaLocationForSWE200() {
		return SWEConstants.NS_SWE_20 + " "
				+ SWEConstants.SCHEMA_LOCATION_SWE_200;
	}

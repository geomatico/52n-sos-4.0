...
public class JTSHelper {
	 ...
	 *             If an error occurs
	 */
	public static Geometry createGeometryFromWKT(String wktString)
			throws OwsExceptionReport {
		...
		try {
			...
			OwsExceptionReport se = new OwsExceptionReport(pe);
	...
	public static String switchCoordinates4String(Geometry sourceGeom) {
		...
		if (switchedCoords.toString().endsWith(" ")) {
			switchedCoords.delete(switchedCoords.toString().length() - 1,
					switchedCoords.toString().length());
		}
	...
	public static String getCoordinates4String(Geometry sourceGeom) {
		...
		if (stringCoords.toString().endsWith(" ")) {
			stringCoords.delete(stringCoords.toString().length() - 1,
					stringCoords.toString().length());
		}

...
public class OMConstants {
    ...
    public static final QName RESULT_MODEL_MEASUREMENT = new QName(NS_OM, EN_MEASUREMENT,
            NS_OM_PREFIX);
    ...
    public static final QName RESULT_MODEL_OBSERVATION = new QName(NS_OM, EN_OBSERVATION,
            NS_OM_PREFIX);
    
    public static final QName RESULT_MODEL_COUNT_OBSERVATION = new QName(NS_OM, EN_COUNT_OBSERVATION,
            NS_OM_PREFIX);

    public static final QName RESULT_MODEL_TRUTH_OBSERVATION = new QName(NS_OM, EN_TRUTH_OBSERVATION,
            NS_OM_PREFIX);

    public static final QName RESULT_MODEL_TEXT_OBSERVATION = new QName(NS_OM, EN_TEXT_OBSERVATION,
            NS_OM_PREFIX);

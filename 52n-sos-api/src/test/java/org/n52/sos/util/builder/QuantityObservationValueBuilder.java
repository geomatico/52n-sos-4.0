...
public class QuantityObservationValueBuilder {
	...
	private IValue<Double> quantity;
	...
	public SosSingleObservationValue<Double> build()
	{
		SosSingleObservationValue<Double> value = new SosSingleObservationValue<Double>();

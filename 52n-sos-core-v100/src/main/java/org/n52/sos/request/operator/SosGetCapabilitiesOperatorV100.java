...
public class SosGetCapabilitiesOperatorV100 implements IRequestOperator {
    ...
    public SosGetCapabilitiesOperatorV100() {
        requestOperatorKeyType =
                new RequestOperatorKeyType(new ServiceOperatorKeyType(SosConstants.SOS, Sos1Constants.SERVICEVERSION),
                        OPERATION_NAME);

...
public class ProcedureDescriptionFormat implements java.io.Serializable {
	...
	public ProcedureDescriptionFormat(long procedureDescriptionFormatId,
	...
	public ProcedureDescriptionFormat(long procedureDescriptionFormatId,
			String procedureDescriptionFormat, Set procedures) {
		this.procedureDescriptionFormatId = procedureDescriptionFormatId;
		this.procedureDescriptionFormat = procedureDescriptionFormat;
	...
	public void setProcedureDescriptionFormatId(
			long procedureDescriptionFormatId) {
		this.procedureDescriptionFormatId = procedureDescriptionFormatId;
	}

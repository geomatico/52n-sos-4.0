...
public class CategoryValue implements Serializable, HasValue<String> {
    public static final String ID = "categoryValueId";
    private static final long serialVersionUID = -8338936029287567501L;

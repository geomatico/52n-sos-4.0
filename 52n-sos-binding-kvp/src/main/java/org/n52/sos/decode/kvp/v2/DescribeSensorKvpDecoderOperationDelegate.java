...
public class DescribeSensorKvpDecoderOperationDelegate extends AbstractKvpDecoderOperationDelegate {

    private static final RequestDecoderKey KVP_DECODER_KEY_TYPE 
            = new RequestDecoderKey(Sos2Constants.SERVICEVERSION, SosConstants.Operations.DescribeSensor.name());
    ...
    @Override
    public DescribeSensorRequest decode(RequestDecoderKey decoderKeyType, Map<String, String> element) throws OwsExceptionReport {

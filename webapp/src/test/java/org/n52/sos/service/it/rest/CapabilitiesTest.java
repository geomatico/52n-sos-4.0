...
public class CapabilitiesTest extends RestBindingTest {
	...
	@Test public void 
	should_return_correct_content_type()
	{
		final MockHttpServletResponse response = getCapabilities();
	...
	@Test public void 
	should_return_valid_sosRest_capabilities()
	{
		final Node xbResponse = getResponseAsNode(getCapabilities());
		
		assertThat(xbResponse, hasXPath("//sosREST:Capabilities/sos:Capabilities",NS_CTXT));
	}
	
	@Test public void 
	should_contain_owsServiceIdentification()
	{
		final Node xbResponse = getResponseAsNode(getCapabilities());
		
		assertThat(xbResponse, hasXPath("//sosREST:Capabilities/sos:Capabilities/ows:ServiceIdentification",NS_CTXT));
	}
	
	@Test public void 
	should_contain_owsServiceProvider()
	{
		final Node xbResponse = getResponseAsNode(getCapabilities());
		
		assertThat(xbResponse, hasXPath("//sosREST:Capabilities/sos:Capabilities/ows:ServiceProvider",NS_CTXT));
	}
	
	@Test public void 
	should_contain_sosfilterCapabilities()
	{
		final Node xbResponse = getResponseAsNode(getCapabilities());
		
		assertThat(xbResponse, hasXPath("//sosREST:Capabilities/sos:Capabilities/sos:filterCapabilities",NS_CTXT));
	}

	@Test public void 
	should_contain_self_link()
	{
	...
	@Test public void 
	should_contain_sensor_create_link()
	{
		final Node response = getResponseAsNode(getCapabilities());
	...
	@Test public void 
	should_contain_observation_create_link()
	{
		final Node response = getResponseAsNode(getCapabilities());
	...
	@Test public void 
	should_contain_observation_link()
	{
		final Node response = getResponseAsNode(getCapabilities());

 ...
 */
public class GetDataAvailabilityTest extends AbstractSosServiceTest {
    @Test
    public void invalidServiceParameter() {
        Node node = getResponseAsNode(execute(RequestBuilder.get("/sos/kvp")
                .query(OWSConstants.RequestParams.request, GetDataAvailabilityConstants.OPERATION_NAME)

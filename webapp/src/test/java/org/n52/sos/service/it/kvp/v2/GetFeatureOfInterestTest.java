 ...
 */
public class GetFeatureOfInterestTest extends AbstractSosServiceTest {

    @Test
    public void invalidServiceParameter() {
        Node node = getResponseAsNode(execute(RequestBuilder.get("/kvp")
                .query(OWSConstants.RequestParams.request, SosConstants.Operations.GetFeatureOfInterest)

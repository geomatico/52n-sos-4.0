...
public class SweCoordinate<T> {
    ...
    /**
     * Coordinate value
     * TODO is this assignment to generic? maybe, we switch to {@link SweAbstractUomType}?
     */
     ...
     *            Coordinate value
     */
    public SweCoordinate(final SweCoordinateName name, final SweAbstractSimpleType<T> value) {
        super();
        this.name = name;
        this.value = value;
    }

...
/**
 * interface for getting feature type description for a passed
...
public interface IDescribeFeatureTypeDAO extends OperationDAO {
     ...
     */
    XmlObject getFeatureOfInterestDescription(AbstractServiceRequest request) throws OwsExceptionReport;
}

...
public interface WritableContentCache extends ContentCache {
    ...
    /**
     * Associate the specified observable property to the specified composite phenomenon.
     *
     * @param compositePhenomenon the composite phenomenon
     ...
     *
     * @param observationIdentifier the observation identifier
     */
    void addObservationIdentifier(String observationIdentifier);

    /**
     * Associate the specified observation identifier with the specified procedure.
     *
     * @param procedure             the procedure
     * @param observationIdentifier the observation identifier
     */
     ...
     *
     * @param observationIdentifier the observation identifiers
     */
     ...
     *
     * @param procedure the procedures
     */
    ...
    /**
     * Dissociate the specified composite phenomenon with the specified offering.
     *
     * @param offering            the offering
     * @param compositePhenomenon the composite phenomenon
     */
    ...
    /**
     * Dissociate all observable properties with the specified composite phenomenon.
     *
     * @param compositePhenomenon the composite phenomenon
     */
    ...
    /**
     * Dissociate the specified observable property with the specified composite phenomenon.
     *
     * @param compositePhenomenon the composite phenomenon
     * @param observableProperty  the observable property
     */
    ...
    /**
     * Dissociate the specified observation identifier with the specified procedure.
     *
     * @param procedure             the procedure
     * @param observationIdentifier the observation identifier
     */
     ...
     *
     * @param offering             the offering
     * @param compositePhenomenons the composite phenomenons
     */
    ...
    /**
     * Updates the envelope for the specified offering to include the specified envelope.
     *
     * @param offering the offering
    ...
    /**
     * Sets the parent procedures for the specified procedure. Generates also a appropiate child procedure structure.
     *
     * @param procedure        the procedure
     * @param parentProcedures the parent procedures
     */
    void setProcedureHierarchy(String procedure, Collection<String> parentProcedures);

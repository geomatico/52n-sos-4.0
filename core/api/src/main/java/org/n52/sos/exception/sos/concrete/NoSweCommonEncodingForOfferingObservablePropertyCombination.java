 ...
 */
public class NoSweCommonEncodingForOfferingObservablePropertyCombination
        extends InvalidPropertyOfferingCombinationException {
    ...
    public NoSweCommonEncodingForOfferingObservablePropertyCombination(String offering, String observableProperty) {
        withMessage("For the requested combination offering (%s) and observedProperty (%s) "
                    + "no SWE Common 2.0 encoded result values are available!",
                    offering, observableProperty);
    }
}

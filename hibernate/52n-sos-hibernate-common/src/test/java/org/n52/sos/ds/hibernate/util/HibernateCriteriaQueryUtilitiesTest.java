 ...
 */
public class HibernateCriteriaQueryUtilitiesTest extends HibernateTestCase {
    ...
    public void getGlobalTemporalBoundingBoxWithNullReturnsNull() {
        assertThat("global temporal bounding box", HibernateCriteriaQueryUtilities.getGlobalTemporalBoundingBox(null), is(nullValue()));
    }
    ...
    public void getTemporalBoundingBoxForOfferingsContainsNoNullElements() throws ConnectionProviderException {
        Session session = getSession();
        try {
            Map<String, TimePeriod> tempBBoxMap = HibernateCriteriaQueryUtilities
                    .getTemporalBoundingBoxesForOfferings(session);

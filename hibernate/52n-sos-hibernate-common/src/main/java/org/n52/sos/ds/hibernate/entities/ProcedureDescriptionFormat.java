...
public class ProcedureDescriptionFormat implements Serializable {
    public static final String PROCEDURE_DESCRIPTION_FORMAT = HasProcedureDescriptionFormat.PROCEDURE_DESCRIPTION_FORMAT;
    public static final String ID = "procedureDescriptionFormatId";
    private static final long serialVersionUID = 1681352216589172881L;

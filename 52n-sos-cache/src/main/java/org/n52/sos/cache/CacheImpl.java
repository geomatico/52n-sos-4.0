...
public class CacheImpl implements CapabilitiesCache{
	...
	public int hashCode()
	{
		final int prime = 31;
		int hash = 1;
		hash = prime * hash + ((allowedKOfferingVObservationType != null) ? allowedKOfferingVObservationType.hashCode() : 0 );
		hash = prime * hash + ((childFeatures != null) ? childFeatures.hashCode() : 0 );
		hash = prime * hash + ((childProcs != null) ? childProcs.hashCode() : 0 );
		hash = prime * hash + ((featureOfInterestIdentifiers != null) ? featureOfInterestIdentifiers.hashCode() : 0 );
		hash = prime * hash + ((featureOfInterestTypes != null) ? featureOfInterestTypes.hashCode() : 0 );
		hash = prime * hash + ((globalEnvelope != null) ? globalEnvelope.hashCode() : 0 );
		hash = prime * hash + ((globalTemporalBoundingBox != null) ? globalTemporalBoundingBox.hashCode() : 0 );
		hash = prime * hash + ((kFeatureOfInterestVProcedures != null) ? kFeatureOfInterestVProcedures.hashCode() : 0 );
		hash = prime * hash + ((kObservablePropertyVOfferings != null) ? kObservablePropertyVOfferings.hashCode() : 0 );
		hash = prime * hash + ((kObservablePropertyVProcedures != null) ? kObservablePropertyVProcedures.hashCode() : 0 );
		hash = prime * hash + ((kOfferingVCompositePhenomenon != null) ? kOfferingVCompositePhenomenon.hashCode() : 0 );
		hash = prime * hash + ((kOfferingVEnvelope != null) ? kOfferingVEnvelope.hashCode() : 0 );
		hash = prime * hash + ((kOfferingVFeaturesOfInterest != null) ? kOfferingVFeaturesOfInterest.hashCode() : 0 );
		hash = prime * hash + ((kOfferingVMaxTime != null) ? kOfferingVMaxTime.hashCode() : 0 );
		hash = prime * hash + ((kOfferingVMinTime != null) ? kOfferingVMinTime.hashCode() : 0 );
		hash = prime * hash + ((kOfferingVName != null) ? kOfferingVName.hashCode() : 0 );
		hash = prime * hash + ((kOfferingVObservableProperties != null) ? kOfferingVObservableProperties.hashCode() : 0 );
		hash = prime * hash + ((kOfferingVObservationTypes != null) ? kOfferingVObservationTypes.hashCode() : 0 );
		hash = prime * hash + ((kOfferingVProcedures != null) ? kOfferingVProcedures.hashCode() : 0 );
		hash = prime * hash + ((kOfferingVRelatedFeatures != null) ? kOfferingVRelatedFeatures.hashCode() : 0 );
		hash = prime * hash + ((kOfferingVResultTemplates != null) ? kOfferingVResultTemplates.hashCode() : 0 );
		hash = prime * hash + ((kProcedureVObservableProperties != null) ? kProcedureVObservableProperties.hashCode() : 0 );
		hash = prime * hash + ((kProcedureVObservationIdentifiers != null) ? kProcedureVObservationIdentifiers.hashCode() : 0 );
		hash = prime * hash + ((kProcedureVOfferings != null) ? kProcedureVOfferings.hashCode() : 0 );
		hash = prime * hash + ((kRelatedFeatureVRole != null) ? kRelatedFeatureVRole.hashCode() : 0 );
		hash = prime * hash + ((observationIdentifiers != null) ? observationIdentifiers.hashCode() : 0 );
		hash = prime * hash + ((observationTypes != null) ? observationTypes.hashCode() : 0 );
		hash = prime * hash + ((parentFeatures != null) ? parentFeatures.hashCode() : 0 );
		hash = prime * hash + ((parentProcs != null) ? parentProcs.hashCode() : 0 );
		hash = prime * hash + ((phens4CompPhens != null) ? phens4CompPhens.hashCode() : 0 );
		hash = prime * hash + ((procedureDescriptionFormats != null) ? procedureDescriptionFormats.hashCode() : 0 );
		hash = prime * hash + ((procedures != null) ? procedures.hashCode() : 0 );
		hash = prime * hash + ((resultTemplates != null) ? resultTemplates.hashCode() : 0 );
		hash = prime * hash + srid;
		hash = prime * hash + ((srids != null) ? srids.hashCode() : 0 );
		return hash;
	}
